...
public class SmsSender {
  ...
  static final String SMS_IOS_VERIFICATION_TEXT        = "Your Exile verification code: %s\n\nOr tap: exile://verify/%s";
  static final String SMS_ANDROID_NG_VERIFICATION_TEXT = "<#> Your Exile verification code: %s\n\nEvqNGMZdqOY";
  static final String SMS_VERIFICATION_TEXT            = "Your Exile verification code: %s";
